...
TC04 : Choose Payment
    Click Element    //*[@id="payment-option-3"]
    Choose File    //*[@id="payment-option-3-additional-information"]/form/input    ${ImageFilePath}
    Sleep    2s
    Click Button    //*[@id="payment-option-3-additional-information"]/form/button
    Sleep    2s
