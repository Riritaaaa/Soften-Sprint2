...
TC04 : Choose Payment
    Click Element    //*[@id="payment-option-4"]
    Choose File    //*[@id="payment-option-4-additional-information"]/form/input    ${ImageFilePath}
    Sleep    2s
    Click Button    //*[@id="payment-option-4-additional-information"]/form/button
    Sleep    2s
